...
const Join = () => {
    ...
    return (
        <div className="outer flex lg:flex-row md:flex-row h-screen lg:w-full min-[320px]:flex-col items-center justify-center  relative bg-zinc-950">
            <Link to="#" className="absolute top-7 right-7 text-white flex items-center text-xl border-2 rounded-3xl p-2">
                Learn more
                <IoInformation className="ml-1" />
            </Link>
            <div style={{ color: '#ccc', WebkitTextFillColor: 'transparent', WebkitTextStrokeWidth: '2px' }} className="absolute top-[13%] left-5 ml-4 text-gray-500 lg:text-[90px] min-[826px]:text-[80px] min-[769px]:text-[80px]  min-[477px]:text-[50px] min-[320px]:text-[40px]">
                Welcome to
            </div>
            <div className="inner backdrop-blur-md bg-opacity-10  bg-clip-padding backdrop-filter border-2 border-zinc-900 lg:w-[30%] lg:h-96 md:w-96 md:h-96 mt-5 text-center flex flex-col justify-center items-center z-10 min-[320px]:h-64">
                ...
                >
                    <button className="button mt-4 text-white text-xl bg-zinc-900 w-24 h-[40px] rounded-3xl border border-white" type="submit">
                        Join
                    </button>
                </Link>
            </div>
            ...
            <div className="inner backdrop-blur-md bg-opacity-10  bg-clip-padding backdrop-filter 
              border-2 border-zinc-900 lg:w-[30%] lg:h-96 md:w-96 md:h-96 mt-5 text-center flex flex-col justify-center items-center z-10 min-[320px]:h-64 lg:ml-5 ">
            ...
            <div style={{ color: '#ccc', WebkitTextFillColor: 'transparent', WebkitTextStrokeWidth: '2px' }} className="absolute bottom-0 left-0 ml-4 text-gray-500 lg:text-[300px] z-0 min-[826px]:text-[230px] min-[769px]:text-[220px]  min-[477px]:text-[140px] min-[320px]:text-[100px] -webkit-text-stroke: 2px teal">
                Huddle.
            </div>
            <div className="absolute lg:right-5 lg:top-[45%] mr-4 text-white text-2xl flex lg:flex-col lg:items-end  md:right-0 md:flex-row md:items-start sm:flex-row sm:items-start md:bottom-0 sm:right-5 sm:bottom-5 min-[320px]:flex-row min-[320px]:left-5 min-[320px]:top-10">
                <FiGithub className="lg:mb-10 min-[320px]:mb-0 min-[320px]:ml-5" />
